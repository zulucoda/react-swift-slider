    ...
    (function (e, t) {
      ...
      try {
        for (
          ...
          !(n = (o = l.next()).done) && (r.push(o.value), !t || r.length !== t);
          n = !0
        );
      } catch (e) {
        (i = !0), (a = e);
...
function S(e) {
  var t = e.src,
    r = e.active,
    n = r ? w.swiftSliderActiveSlideClass : w.swiftSliderSlideClass;
...
function B(t) {
          ...
          e.useEffect(
            function () {
              ...
              return (
                (i.current = e),
                function () {
                  (i.current = null), clearInterval(e);
                }
              );
            },
            [r, i.current],
  ...
  return i.default.createElement(
    R,
    { height: n, className: w.swiftSliderContainerClass },
    i.default.createElement(
      z,
      { height: n, className: w.swiftSliderSlidesClass },
      r.map(function (e, t) {
    ...
    c
      ? i.default.createElement(E, {
          onPressPrev: function () {
            if (0 === d) return p(r.length - 1);
            p(d - 1), clearInterval(h);
          },
          direction: m,
          height: n,
        })
      : '',
    c
      ? i.default.createElement(E, { onPressNext: v, direction: b, height: n })
      : '',
  );
}
(B.propTypes = {
